                        ...
                        imageRef.putData(imageData, metadata: nil) { metadata, error in
                            if error != nil {
                                ...
                                imageRef.downloadURL { url, error in
                                    ...
                                    let firestoreMusic = ["userID": currentUserID, "musicUrl": postUrl, "musicID": sharePostRef.documentID, "songName": songName, "lyrics": lyrics, "coverPhotoURL": imageUrl, "name": name, "musicFileType": musicFileType, "time": Timestamp(date: Date())] as [String: Any]
